         ...
         <section className="social-media">
            <div className="social-media-wrap">
                <div className="footer-logo">
                    <Link className="social-logo">TRVL with Bhuvi <i className="fab fa-typo3"></i></Link>
                </div>
                <small className="website-rights">Bhuvi Sanathara 2023</small>
            ...
            <Link class='social-icon-link linkdin' to='/' target='_blank' aria-label='LinkedIn' >
